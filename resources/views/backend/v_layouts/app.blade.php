...
<head>
    ...
    <title>Kedai Kopi Admin - {{ $judul }}</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Kedai Kopi @if (Auth::user()->role == 0) Pemilik @else Admin @endif </div>
            </a>
            ...
            <!-- Nav Item - Produk -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('backend.produk.index') }}">
                    <i class="fas fa-fw fa-table"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('backend.profil.index') }}">
